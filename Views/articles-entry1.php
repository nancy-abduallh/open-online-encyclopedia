                ...
                <div class="sign_right signup_right">
                    <div class="sign_inner signup_inner">
                        ...
                        <div class="col-lg-12 form-group">
                            ...
                            <div class="col-lg-12 form-group">
                                <div class="small_text" style="color: black; margin-left:440px;">تاريخ الاصدار</div>
                            ...
                            <div class="col-lg-12 form-group">
                                <div class="small_text" style="color: black; margin-left:450px;">لينك المقال</div>
                            ...
                            <input type="submit" value="أضف المقال"   name="add_article" class="btn action_btn thm_btn">
