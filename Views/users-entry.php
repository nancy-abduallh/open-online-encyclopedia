            ...
            <div class="row ml-0 mr-0">
                ...
                <div class="sign_right signup_right">
                    <div class="sign_inner signup_inner">
                        ...
                        <form action="added_user.php" method="post"  class="row login_form">
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <input type="email" name="email" class="form-control" style="color: black;" id="email" placeholder="info@Docy.com" required>
                            </div>
                            <div class="col-lg-12 form-group">
                                <div class="small_text" style="color: black;">Age</div>
                                <input id="age" name="age" type="text" style="color: black;" class="form-control" placeholder="Type your Age " autocomplete="off">
                            </div>
                            <div class="col-lg-12 form-group">
                                <div class="small_text" style="color: black;">Gender</div>
                                <input id="gender" name="gender" type="text" style="color: black;" class="form-control" placeholder="Male or Female" autocomplete="off">
                            </div>
                            <div class="col-lg-12 form-group">
                            ...
                            <div class="col-lg-12 text-center">
                                <button type="submit" name="add_user" class="btn action_btn thm_btn">Add User</button>
                            </div>
                        </form>
                    </div>
                </div>
