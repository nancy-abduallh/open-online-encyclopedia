...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<p id='username'><strong> <u>اسم المستخدم:</u> </strong></p>" . $row["username"] . "<br> " ;
        echo"<p id='comment'> <strong><u>التعليق:</u></strong></p>". $row["comment_text"] ."<br> ";
        echo '</div>';
    }
} else {
    echo '<div class="placeholder" >';
    echo "لا تعليقات حتى الآن. ";
    echo '</div>';
