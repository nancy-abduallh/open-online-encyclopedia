            ...
            // $password = md5($password);
                    ...
                    if(!$result){
                                ...
                                echo"<h5  >Error Message</h5>";
                                    ...
                                    echo"<a class='btn btn-warning btn-big'  href='users-entry.php'><button>Go Back<button></a> </div>";
                                echo"</div>";
                                echo"</div>";
                            echo"</div>";
                            echo"</div>";
                        echo"</div>";
                                ...
                                echo"<div class='widget-content'>";
                                    ...
                                    echo"<a class='btn btn-inverse btn-big'  href='editor page.php'><button>Go Back</button></a> </div>";
                                echo"</div>";
                                echo"</div>";
                            echo"</div>";
                            echo"</div>";
                        echo"</div>";
                            ...
                            echo"<h3>YOU ARE NOT AUTHORIZED TO REDIRECT THIS PAGE. GO BACK to <a href='users_entry.php'> DASHBOARD </a></h3>";
                        }
    ?>  
